...
export interface ScanRow { id: string; started_at: string; finished_at: string | null; status: string; targets: string[]; discovered: number; hosts_found: number; error: string }
